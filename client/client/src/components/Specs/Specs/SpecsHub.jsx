      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <input
            ...
            style={{ width: '200px', fontSize: '11.5px' }}
          ...
          groups.map(group => (
            <div key={group.key || group.label} style={{ marginBottom: '32px' }}>
              ...
              {viewMode === 'grid' ? (
                ...
                <div style={{ overflowX: 'auto', borderRadius: '8px', border: '1px solid var(--border-color)', background: 'var(--card-bg)' }}>
                  <table className="modern-mat-table" style={{ width: '100%', fontSize: '11px' }}>
                    <thead>
                      <tr>
